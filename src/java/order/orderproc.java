...
//        processRequest(request, response);
        ...
        int password=Integer.parseInt(request.getParameter("quantity"));
        
        System.out.print(name+" lolol "+password);
        
        dbcon db = dbcon.getInstance();
        
         try{
        Statement st=db.getdbcon();
        String query = "INSERT INTO `archilab2`.`order` (`item_name`, `item_quantity`) VALUES ('"+name+"', '"+password+"');";
